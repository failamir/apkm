<?php 
$batas = '40';
$file = 'storage/app/public/21/Data-LMS-+-Nilai---ICEI-Rev-21.03.2021-(1).xlsx';
...
exec("python3 public/Proses.py '$batas' '$file' '$date'", $out, $ret);
// exec("python3 public/ProsesOngoing.py '$file2' '$date'", $out, $ret);
// var_dump($proses);
