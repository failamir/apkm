...
class PreparationDataApiController extends Controller
{
    public function index()
    {
        ...
        return new PreparationDataResource(PreparationData::with(['mataKuliah'])->advancedFilter());
    }
    ...
    public function show(PreparationData $preparationData)
    {
        ...
        return new PreparationDataResource($preparationData->load(['mataKuliah']));
    }
    ...
    public function edit(PreparationData $preparationData)
    {
        ...
        return response([
            'data' => new PreparationDataResource($preparationData->load(['mataKuliah'])),
            'meta' => [
                'mata_kuliah' => MataKuliah::get(['id', 'nama_mtk']),
            ],
        ]);
